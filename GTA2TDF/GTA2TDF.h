...
inline char GTA2TDF_MARKET_STATUS(const char *TradeStatus, const char *SecurityPhaseTag) {
	//null 正常交易
...
inline void GTA2TDF_SSEL2(const SSEL2_Quotation &src, TDF_MARKET_DATA &m, TDF_ORDER_QUEUE &qB, TDF_ORDER_QUEUE &qS) {
...
inline void GTA2TDF_SSEL2_T(const SSEL2_Transaction &src, TDF_TRANSACTION &t) {
	//char    szCode[32];                 //原始Code
...
inline void GTA2TDF_SZSEL2(const SZSEL2_Quotation &src, TDF_MARKET_DATA &m, TDF_ORDER_QUEUE &qB, TDF_ORDER_QUEUE &qS) {
	//char        szWindCode[32];         //600001.SH
	strcpy(m.szWindCode, src.Symbol);
	m.szWindCode[6] = '.';
	m.szWindCode[7] = 'S';
...
inline void  GTA2TDF_SZSEL2_T(const SZSEL2_Transaction &src, TDF_TRANSACTION &t) {
	//char    szWindCode[32];             //600001.SH
	strcpy(t.szWindCode, src.Symbol);
	t.szWindCode[6] = '.';
	t.szWindCode[7] = 'S';
...
inline void GTA2TDF_SZSEL2_O(const SZSEL2_Order &src, TDF_ORDER &o) {
	//char    szWindCode[32]; //600001.SH 
